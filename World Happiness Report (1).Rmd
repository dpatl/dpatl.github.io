...
Our data set is now tidy so we can start analyzing and inferring information from our data manipulation operations. This is accomplsihed through data visualization, and statistical measures.  

Lets look at our original mean and stanard deviation before we do any data transformations.
```{r mean, include = TRUE}
